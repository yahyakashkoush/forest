...
const HomePage = () => {
  ...
  const fetchFeaturedProducts = async () => {
    try {
      ...
      const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/api/products?featured=true&limit=6`)
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {loading ? (
            <div className="flex justify-center items-center py-20">
              <div className="loading-spinner text-forest-accent"></div>
              <span className="ml-4 text-gray-400">Loading featured products...</span>
            </div>
          ) : (
                ...
                >
                  <div className="relative h-80 overflow-hidden">
                    {product.images && product.images.length > 0 ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-b from-forest-gray to-forest-darkGreen flex items-center justify-center">
          ...
          >
            <Link href="/shop" className="forest-btn text-lg px-8 py-3">
